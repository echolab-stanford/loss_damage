...
################################################################################
# read data 
world_emissions <- readRDS(paste0(getwd(), "/data/figures/20230629/world_emissions.rds"))
world_minus_us_emms <- readRDS(paste0(getwd(), "/data/figures/20230629/world_minus_us_emms.rds"))
gtc1_fair_exp <- readRDS(paste0(getwd(), "/data/figures/20230629/gtc1_fair_exp.rds"))
y <- rast(paste0(getwd(), "/data/figures/20230629/y.tiff"))
v <- vect(paste0(getwd(), "/data/figures/20230629/v.shp"))
annual_observed <- readRDS(paste0(getwd(), "/data/figures/20230629/annual_observed.rds"))
usa_bra <- readRDS(paste0(getwd(), "/data/figures/20230629/usa_bra.rds"))
sum_usa_bra <- readRDS(paste0(getwd(), "/data/figures/20230629/sum_usa_bra.rds"))
dev.off()
################################################################################
################################################################################
# visualize data   
pdf(file = paste0(getwd(), "/figures/20230629/fig2_pre_illustrator.pdf"),   # The directory you want to save the file in
