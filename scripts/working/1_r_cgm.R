...
calculate_grid_warming_ratio <- function(run1, run2, cgm_model) {
  ...
  raster_ssp3 <- readAll(raster::brick(paste0("~/BurkeLab Dropbox/Projects/loss_damage/data/raw/historical_ssp370/tas_Amon_", run1, 
  ...
  raster_hist <- readAll(raster::brick(paste0("~/BurkeLab Dropbox/Projects/loss_damage/data/raw/historical_ssp370/tas_Amon_", run2, 
                                              "_",cgm_model, "_ann_mean_2pt5degree.nc"),
                                       varname = "tas"))
