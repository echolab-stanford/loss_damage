...
ex$scenario[6] <- "Growth at 2100 + 5lag BHM + No impacts > 2100"
ex$scenario[7] <- "No growth effects > 2100"
ex$scenario[8] <- "No impacts > 2100"
...
ex$dr1[6] <- round(sum(scc_2100_2100_5lag$weighted_damages1_scld, na.rm = T),0)
ex$dr1[7] <- round(sum(scc_2300_nog_post_2100$weighted_damages1_scld, na.rm = T),0)
ex$dr1[8] <- round(sum(scc_2100$weighted_damages1_scld, na.rm = T),0)
...
ex$dr2[6] <- round(sum(scc_2100_2100_5lag$weighted_damages2_scld, na.rm = T),0)
ex$dr2[7] <- round(sum(scc_2300_nog_post_2100$weighted_damages2_scld, na.rm = T),0)
ex$dr2[8] <- round(sum(scc_2100$weighted_damages2_scld, na.rm = T),0)
...
ex$dr3[6] <- round(sum(scc_2100_2100_5lag$weighted_damages3_scld, na.rm = T),0)
ex$dr3[7] <- round(sum(scc_2300_nog_post_2100$weighted_damages3_scld, na.rm = T),0)
ex$dr3[8] <- round(sum(scc_2100$weighted_damages3_scld, na.rm = T),0)
...
ex$dr_ramsey[6] <- round(sum(scc_2100_2100_5lag$weighted_damages_ramsey_scld, na.rm = T),0)
ex$dr_ramsey[7] <- round(sum(scc_2300_nog_post_2100$weighted_damages_ramsey_scld, na.rm = T),0)
ex$dr_ramsey[8] <- round(sum(scc_2100$weighted_damages_ramsey_scld, na.rm = T),0)
...
ex$regression_model[6] <- "5-lag BHM model"
ex$regression_model[7] <- "0-lag BHM model"
ex$regression_model[8] <- "0-lag BHM model"
