...
################################fig S12b#####################################
figs12b <- as.data.frame(data_frame(scenario = c("baseline", "90% of emissions",
                                                 "70%", "50%" , "30%"), 
                              value = c(-10.26/-10.26,
...
run_date <- "loss_damage_r1"
setwd("~/GitHub/loss_damage/")
write_rds(figs12b, paste0(getwd(), "/data/figures/",run_date, "/damages_under_diff_baseline_scenarios.rds"))
