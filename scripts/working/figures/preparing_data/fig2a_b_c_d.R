...
#############################################################################
# read data 
total_damages_1gtco2_cd <- readRDS(paste0(output_path,"/total_damages_1gtco2_1990_2022.rds"))
total_damages_1gtco2 <- readRDS(paste0(output_path, "/total_damages_1gtco2_1990_2022.rds"))
