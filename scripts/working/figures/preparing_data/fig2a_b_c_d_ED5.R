...
# This R script reads the data and prepares the necessary data to plots figures
# 2a, 2b, 2c, 2d, and ED5
# input(s): 
# - "~/BurkeLab Dropbox/data/output/{run_date}/total_damages_1gtco2_1990_2020.rds"
# - "~/BurkeLab Dropbox/data/output/{run_date}/total_damages_1gtco2_1990_2020.rds"
# output(s):
...
# now focus on historical period
...
# ok bring them all under one dataset 
...
# now bring them all into one dataset 
...
test_df_for_table_2100 <- total_damages_by_pulse_2100 %>% 
...
test_df_for_table_2020 <- total_damages_by_pulse_2020 %>% 
  dplyr::select(c("emitter",
                  "total_damages_dr1_5",
                  "total_damages_dr2",
                  "total_damages_dr3",
...
# ok now let us read in the world shapefile 
world <- spData::world
