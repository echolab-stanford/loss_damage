...
# This R script plots the data for figure 2e
# input(s): 
# - "~/Github/loss_damage/data/figures/{run_date}/listof_scc_est_dfs_fig2e.RData"
# output(s):
# - "~/Github/loss_damage/figures/{run_date}/fig2e_5lag_v3.pdf"
############################################################################# set up the env
remove(list=ls())
gc()
sf::sf_use_s2(FALSE)
...
################################################################################
################################################################################ prep the data
# setting up medians, IQR, and perentiles 
...
# add all the different scenarios on the figure starting with the damages through 2100 
# under 2% discount rate 
...
# now under ramsey discount rate
...
# no growth impact past 2100 
# under 25 discount rate 
...
# now let us do under ramsey discount rate
...
## now let us do no impcats past 2100 
# under 2% discount rate 
...
polygon(x = c(17950, 18050,
        ...
        y = c(11.75, 11.75,12.25, 12.25), # Y-Coordinates of polygon
        col = "gold1")  
# ok continue constructing the legend
