...
figs12b <- readRDS(paste0(getwd(), "/data/figures/", run_date, "/damages_under_diff_baseline_scenarios.rds"))
...
ex %>%
  ...
  gtsave(paste0("~/GitHub/loss_damage/figures/", run_date, "/figS12.png"))
...
figs12b$scenario_id <- 1:5
pdf(file = paste0("~/GitHub/loss_damage/figures/",run_date,"/figS12b.pdf"),   # The directory you want to save the file in
...
plot(figs12b$scenario_id, figs12b$value, type = "l", xaxt = "n", 
     frame.plot = F, las = 1, 
     ylab = "USA damages\nrelative to baseline scenario", 
     xlab = "Baseline emissions for 1990-2020 period", cex.axis = 1.15, cex.lab = 1.25)
points(figs12b$scenario_id, figs12b$value, col = egy, pch = 19, cex = 2.25)
points(figs12b$scenario_id, figs12b$value, col = "black", pch = 21, cex = 2.3, lwd = 1.55)
axis(1, figs12b$scenario, at = figs12b$scenario_id, cex.axis = 1.15)
