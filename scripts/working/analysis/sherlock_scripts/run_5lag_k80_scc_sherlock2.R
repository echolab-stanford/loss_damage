...
# fair dataframes 
fair_exps_1tco2_disagg <- readRDS(paste0(path, "fair_exps_disagg_k80_20230821.rds"))
...
gdp_temp_data_k80_5lag <- readRDS(paste0(path, "gdp_temp_data_5lags_k80_2100.rds"))
...
list_of_exps_1980_2020 <- 1980:2020
...
foreach(i=308:1000) %dopar% {
  ...
  damages_i <- calculate_damages_pulse(raster_i,
                                       ...
                                       list_of_exps_1980_2020,
                                       1980,
                                       future_forecast_ssp370,
                                       gdp_temp_data_k80_5lag,
                                       "ERA",
                                       bhm_era_reg,
                                       T,
                                       "NO",
