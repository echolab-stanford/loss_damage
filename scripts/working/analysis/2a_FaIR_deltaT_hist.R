...
# and outputs a median or range of estimates for temperature response to 
# emissions according to FaIR.
# Input(s): raw FaIR temperature response data from desired experiments
# Output(s): processed median FaIR temperature response to be used with the 
# calculated CGM warming ratio in the previous step
# Outputs using this script: The dataframe with bilateral transfers (including - 
# damages and benefits) with the amount owed by each country to other countries
